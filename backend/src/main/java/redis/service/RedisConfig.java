...
public class RedisConfig {
    ...
    //    @Bean
//    public BestBidRedisTemplate redisTemplate() {
//        final BestBidRedisTemplate template = new BestBidRedisTemplate();
//        template.setConnectionFactory(jedisConnectionFactory());
//        template.setValueSerializer(new GenericToStringSerializer<Bid>(Bid.class));
//        return template;
//    }
    @Bean
